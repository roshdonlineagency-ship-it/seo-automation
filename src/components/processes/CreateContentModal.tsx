    ...
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-5" dir="rtl">
      <div className="w-full max-w-4xl bg-[#111111] border border-white/10 rounded-3xl overflow-hidden max-h-[90vh] flex flex-col">
        ...
        <div className="p-6 overflow-y-auto flex-1">
          ...
          {/* استپ ۱ — ورودی‌ها و انتخاب ۲ پرامپت */}
          {step === 1 && (
          ...
          {/* استپ ۲ — کپی پرامپت اولیه و پیست کردن جیسان */}
          {step === 2 && (
            <div className="space-y-5">
              <div>
                <p className="text-amber-400 text-xs mb-2 font-medium">۱. متن زیر را کپی کنید و در چت‌بات هوش مصنوعی خود (کلاود، جی‌پتی و...) اجرا کنید:</p>
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="کلیدها یا کل متون آبجکت JSON تولیدی را اینجا وارد کنید..."
                  className="w-full h-44 bg-white/5 border border-white/10 rounded-xl p-4 text-xs text-white font-mono focus:outline-none focus:border-emerald-500"
                />
              </div>
          ...
          {/* استپ ۳ — میز تحریریه تعاملی و سکشن‌ها */}
          {step === 3 && articleData && (
            <div className="space-y-6">

              {/* کادر داینامیک کپی پرامپت اصلاحیه و پیست مجدد جیسان اصلاح‌شده */}
              {isWaitingForCorrection && (
                <div className="bg-amber-500/10 border border-amber-500/30 p-5 rounded-2xl space-y-4">
                  ...
                  />
                  <div>
                    <p className="text-emerald-400 text-xs font-semibold mb-2">📥 حالا خروجی JSON اصلاح‌شده نهایی را در کادر زیر پیست کنید:</p>
                    <textarea
                      value={correctionPastedJson}
                      onChange={(e) => setCorrectionPastedJson(e.target.value)}
                      placeholder="متن کامل آبجکت JSON جدید اصلاح شده..."
                      className="w-full h-32 bg-black/60 border border-white/10 rounded-xl p-3 text-xs text-white font-mono focus:outline-none focus:border-emerald-500"
                    />
                  </div>
                  <div className="flex gap-2 justify-end">
                    ...
                    >
                      🔄 بروزرسانی میز تحریریه با دیتای جدید
                    </button>
                  </div>
                </div>
              )}
